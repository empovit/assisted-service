...
def main():
    ...
    with open(SRC_FILE, "r") as src:
        with open(DST_FILE, "w+") as dst:
            ...
            data = data.replace("REPLACE_BASE_URL", utils.get_service_url(service=SERVICE, target=deploy_options.target,
                                                                          domain=deploy_options.domain, namespace=deploy_options.namespace,
